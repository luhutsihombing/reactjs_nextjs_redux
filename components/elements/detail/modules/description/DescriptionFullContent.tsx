  ...
  <div className="ps-product__content">
    ...
    <div className="ps-document">
      ...
      <p>
        ...
        retirement – the S6 had it, then the Note5 didn’t, and now with the S7 the trend is clear.
      </p>
      ...
      <p>
        ...
        before plugging in. Samsung hasn’t reinvented the wheel with the design of the Galaxy S7,
        but it didn’t need to. The Gala S6 was an excellently styled device, and the S7 has managed
        to improve on that.
      </p>
    </div>
    ...
    <p>
      ...
      vision to become the one-stop shop for retail in New York with implementation of best
