            ...
            <Slider
              ...
              <div className="item">
                <a href="/static/img/products/detail/on-sale/1.jpg">
                  <img src="/static/img/products/detail/on-sale/1.jpg" alt="martfury" />
                </a>
              </div>
              <div className="item">
                <a href="/static/img/products/detail/on-sale/2.jpg">
                  <img src="/static/img/products/detail/on-sale/2.jpg" alt="martfury" />
                </a>
              </div>
              <div className="item">
                <a href="/static/img/products/detail/on-sale/3.jpg">
                  <img src="/static/img/products/detail/on-sale/3.jpg" alt="martfury" />
                </a>
              </div>
              <div className="item">
                <a href="/static/img/products/detail/on-sale/4.jpg">
                  <img src="/static/img/products/detail/on-sale/4.jpg" alt="martfury" />
                </a>
              </div>
            </Slider>
          </div>
