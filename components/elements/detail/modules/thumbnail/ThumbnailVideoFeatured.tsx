            ...
            <Slider
              ...
              <div className="item">
                <a href="/static/img/products/detail/fullwidth/1.jpg">
                  <img src="/static/img/products/detail/fullwidth/1.jpg" alt="martfury" />
                </a>
              </div>
              <div className="item">
                <a href="/static/img/products/detail/fullwidth/2.jpg">
                  <img src="/static/img/products/detail/fullwidth/2.jpg" alt="martfury" />
                </a>
              </div>
              <div className="item">
                <a href="/static/img/products/detail/fullwidth/23.jpg">
                  <img src="/static/img/products/detail/fullwidth/3.jpg" alt="martfury" />
                </a>
              </div>
