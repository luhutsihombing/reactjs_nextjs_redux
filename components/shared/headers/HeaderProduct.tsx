...
class HeaderProduct extends Component<{productData: any; dispatch?(val: any): void}> {
  constructor(props) {
    super(props);
  }
          ...
          <div className="container">
            <article className="ps-product--header-sticky">
              <div className="ps-product__thumbnail">
                <img src="/static/img/products/detail/fullwidth/1.jpg" alt="" />
              </div>
              <div className="ps-product__wrapper">
                <div className="ps-product__content">
                  <Link href="/product/[pid]" as={`/product/${productData.id}`}>
                    <a className="ps-product__title">{productData.title}</a>
                  </Link>
                </div>
                <div className="ps-product__shopping">
                  ...
                  <a className="ps-btn" href="#" onClick={e => this.handleAddItemToCart(e)}>
                    Add to Cart
                  </a>
                </div>
              </div>
