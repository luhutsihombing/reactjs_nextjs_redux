        ...
        <div className="ps-section__right">
          <section className="ps-store-box">
            <div className="ps-section__header">
              ...
              <Select placeholder="Sort by" style={{width: '100%', maxWidth: '200px'}}>
                    ...
                    <div className="ps-block__content">
                      <div className="ps-block__author">
                        <a className="ps-block__user" href="#">
                          <img src="/static/img/vendor/store/user/3.jpg" alt="martfury" />
                        </a>
                      ...
                      <ul className="ps-block__contact">
                        ...
                        <li>
                          <i className="icon-telephone" /> (+093) 77-637-3300
                        </li>
                      </ul>
                      <div className="ps-block__inquiry">
                        <a href="#">
                          <i className="icon-question-circle" /> inquiry
                        </a>
                      </div>
                    </div>
                  </article>
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                  <article className="ps-block--store">
                    ...
                    <div className="ps-block__content">
                      <div className="ps-block__author">
                        <a className="ps-block__user" href="#">
                          <img src="/static/img/vendor/store/user/4.jpg" alt="martfury" />
                        </a>
                        <a className="ps-btn" href="#">
                          Visit Store
                        </a>
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                  <article className="ps-block--store">
                    ...
                    <div className="ps-block__content">
                      <div className="ps-block__author">
                        <a className="ps-block__user" href="#">
                          <img src="/static/img/vendor/store/user/5.jpg" alt="martfury" />
                        </a>
                        <a className="ps-btn" href="#">
                          Visit Store
                        </a>
