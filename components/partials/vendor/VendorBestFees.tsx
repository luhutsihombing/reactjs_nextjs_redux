  ...
  <div className="ps-section--vendor ps-vendor-best-fees">
    <div className="container">
      ...
      <div className="ps-section__content">
        <h5>
          It doesn’t cost a thing to list up to 50 items a month, and you only pay after your stuff
          sells. It’s just a small percent of the money you earn
        </h5>
        ...
        <div className="ps-section__highlight">
          ...
          <figure>
            <p>
              We process payments with PayPal, an external payments platform that allows you to
              process transactions with a variety of payment methods. Funds from PayPal sales on
        ...
        <div className="ps-section__footer">
          <p>
            Listing fees are billed for 0.20 USD, so if your bank’s currency is not USD, the amount
            in your currency may vary based on changes in the exchange rate.
          </p>
        </div>
      </div>
    </div>
