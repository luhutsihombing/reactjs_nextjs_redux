...
import {onSale} from '../../../../public/static/data/product.json';

class HomeDefaultDealOfDay extends PureComponent {
  render() {
        ...
        <div className="ps-container">
          ...
          <div className="ps-section__content">
            <Slider {...carouselSetting} className="ps-carousel outside">
              {onSale.map(product => (
                <ProductDealOfDay product={product as any} key={product.title} />
              ))}
            </Slider>
          </div>
        </div>
