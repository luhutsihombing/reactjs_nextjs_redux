...
import products from '../../../../public/static/data/home-1.json';
          ...
          <div className="ps-section__content">
            <div className="row">
              {products.newArrivals.map(product => (
                <div className="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 " key={product.title}>
                  <ProductHorizontal product={product as any} />
                </div>
              ))}
            </div>
          </div>
