...
import {marketPlaceHotDeal} from '../../../../public/static/data/martketplace.json';

class MarketPlace4Dealhot extends Component<{data: any[]}> {
  slider: Slider;
              ...
              <div className="ps-block--deal-hot" data-mh="dealhot">
                ...
                <div className="ps-product__content">
                  <Slider
                    ...
                    {...mainSliderSettings}>
                    {(marketPlaceHotDeal as any).map(product => (
...
export default MarketPlace4Dealhot;
