...
import {dealHotProducts} from '../../../../public/static/data/autopart.json';
import ProductDealHot from '../../../elements/products/ProductDealHot';

class AutopartDealHot extends Component<{data: any[]}> {
  slider: Slider;
              ...
              <div className="ps-block--deal-hot" data-mh="dealhot">
                <div className="ps-block__header">
                  ...
                  <div className="ps-block__navigation">
                    <a className="ps-carousel__prev" href="#" onClick={this.handleCarouselPrev}>
                      <i className="icon-chevron-left" />
                    </a>
                    <a className="ps-carousel__next" href="#" onClick={this.handleCarouselNext}>
                ...
                <div className="ps-product__content">
                  <Slider
                    ...
                    {dealHotProducts.map(product => (
                      <ProductDealHot product={product as any} key={product.id} />
                    ))}
                  </Slider>
                </div>
              </div>
