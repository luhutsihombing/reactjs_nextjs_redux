...
class MarketHealthyAndBeauty extends PureComponent<{data: any[]}> {
  constructor(props) {
    super(props);
  }
    ...
    return (
      <div className="ps-block--products-of-category">
        ...
        <div className="ps-block__product-box">
          {(data as any).map((product, index) => {
            return index < 6 ? <ProductSimple product={product} key={product.id} /> : '';
          })}
        </div>
      </div>
    );
...
export default MarketHealthyAndBeauty;
