                      ...
                      {this.state.method === 1 ? (
                        <div className="ps-block__tab">
                          ...
                          <div className="form-group">
                            ...
                            <input id="cardHolder" type="text" className="form-control" />
                          </div>
                          <div className="row">
                            <div className="col-8">
                              <div className="form-group">
                                ...
                                <div className="row">
                                  <div className="col-6">
                                    <Select id="expDate" defaultValue={1}>
                                      {month.map(item => (
                            ...
                            <div className="col-4">
                              <div className="form-group">
                                ...
                                <input id="cvv" type="text" className="form-control" />
                              </div>
                            </div>
                          </div>
                          <div className="form-group">
                        ...
                        <div className="ps-block__tab">
                          <a className="ps-btn">Process with Paypal</a>
                        </div>
                      )}
                    </div>
                  </div>
