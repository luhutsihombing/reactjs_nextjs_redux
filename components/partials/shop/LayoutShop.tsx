...
class LayoutShop extends Component<{products: any[]}, {listView: boolean}> {
  constructor(props) {
    super(props);
    this.state = {
      listView: true
        ...
        <div className="ps-layout__right">
          <div className="ps-shopping">
            ...
            <div className="ps-shopping__header">
              <p>
                <strong className="mr-2">{allProducts ? allProducts.length : 0}</strong>
                Products found
              </p>
            ...
            <div className="ps-shopping__content">
              {viewMode === true ? (
                  ...
                  <div className="row">
                    {allProducts && allProducts.length > 0
                      ? allProducts.map(item => (
                          <div className="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6 " key={item.id}>
                ...
                <div className="ps-shopping-product">
                  {allProducts && allProducts.length > 0
                    ? allProducts.map(item => <ProductWide product={item} key={item.id} />)
                    : ''}
                </div>
              )}
