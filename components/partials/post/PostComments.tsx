  ...
  <div className="ps-post-comments">
    ...
    <div className="ps-block--comment">
      ...
      <div className="ps-block__content">
        ...
        <p>
          Cras id nulla at metus congue auctor. Suspendisse auctor dictum orci quis interdum. Nullam
          et eleifend metus. Integer in est orci. Duis hendrerit ex metus, vel tempor sem aliquet
    ...
    <div className="ps-block--comment">
      ...
      <div className="ps-block__content">
        ...
        <p>
          Ut tellus ligula, interdum a interdum ut, egestas ut ipsum. Vivamus viverra consequat
          ipsum, nec auctor dolor eleifend sit amet. Nulla cursus fringilla metus a dictum
        </p>
        <a className="ps-block__reply" href="#">
          Reply
        </a>
    ...
    <form className="ps-form--post-comment" action="do_action" method="post">
      ...
      <div className="form-group">
        <textarea className="form-control" rows={8} placeholder="Your comment *" required />
      </div>
      <div className="row">
